      ...
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            ...
            className="card-modern group block text-left relative overflow-hidden transition-all duration-200 hover:shadow-md hover:border-blue-300"
          >
             ...
             <div className="relative z-10">
                <h3 className="text-2xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors mb-2 flex items-center gap-2">
          ...
          <Link
            ...
            className="card-modern group block text-left relative overflow-hidden transition-all duration-200 hover:shadow-md hover:border-violet-300"
          >
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
            ...
            <div className="relative z-10">
                <h3 className="text-2xl font-bold text-gray-900 group-hover:text-violet-600 transition-colors mb-2 flex items-center gap-2">
